...
| Rage of Mages II | Separate `R2-*` findings and ROM2 format pages from the reported preserved RU installation | Treat source identity and scope separately from ROM1. The functional asset ledger and survey dependencies are published; the underlying evidence remains private, with bounded field/runtime Unknowns. |
