...
| ALM |83 complete record chains with the type0 overhang; per-type layouts, dispatcher, metadata growth and type6 widths mapped (`R2-ASSET-002`, `R2-ASSET-003`, `R2-ASSET-017` through `R2-ASSET-024`, `R2-ASSET-027` (partially retracted: maxima attribution only), `R2-SESSION-010`) | New-type field meanings and the writer's declared-size split remain Unknown | [ALM](../rom2-alm/format.md) |
